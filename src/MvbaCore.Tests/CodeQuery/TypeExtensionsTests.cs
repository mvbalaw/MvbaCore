...
namespace MvbaCore.Tests.CodeQuery
{
	...
	public class TypeExtensionsTests
	{
		...
		public class When_asked_if_a_type_is_generic_and_assignable_from_a_specific_type
		{
			...
			{
				var result = typeof(Dictionary<,>).IsGenericAssignableFrom(typeof(int));
			...
			{
				var result = typeof(HashSet<>).IsGenericAssignableFrom(typeof(int));
				result.ShouldBeFalse();
			}
			...
			{
				var result = typeof(int?).IsGenericAssignableFrom(typeof(int));
				result.ShouldBeTrue();
			}
			...
			{
				var result = typeof(int?).IsGenericAssignableFrom(typeof(Guid?));
				result.ShouldBeFalse();
			}
			...
			{
				var result = typeof(IEnumerable<>).IsGenericAssignableFrom(typeof(int));
				result.ShouldBeFalse();
			}
			...
			{
				var result = typeof(IEnumerable<int>).IsGenericAssignableFrom(typeof(HashSet<int>));
				result.ShouldBeTrue();
			}
		}
	}
